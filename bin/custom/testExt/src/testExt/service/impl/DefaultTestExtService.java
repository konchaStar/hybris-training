...
public class DefaultTestExtService implements TestExtService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTestExtService.class);
	...
	{
		return DefaultTestExtService.class.getResourceAsStream("/testExt/sap-hybris-platform.png");
	}
