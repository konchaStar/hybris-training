...
<html lang="en">
<head>
    <title>Welcome to testExt</title>
    <link rel="stylesheet" href="<c:url value="/static/testExt-webapp.css"/>" type="text/css"
          media="screen, projection"/>
</head>
<div class="container">
    <img src="<c:url value="${logoUrl}" />" alt="Hybris platform logo"/>

    <h2>Welcome to "testExt" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><strong>resources/testExt-items.xml</strong> - here you can model your items</li>
            <li><strong>resources/testExt-spring.xml</strong> - here you can define your services</li>
            <li><strong>web/webroot/WEB-INF/config/testExt-spring-mvc-config.xml</strong> - here is a Spring MVC related
                configuration
            </li>
            <li><strong>web/webroot/WEB-INF/config/testExt-web-app-config.xml</strong> - here you can define web related services,
                facades etc.
            </li>
            <li><strong>web/webroot/WEB-INF/config/testExt-spring-security-config.xml</strong> - here you can configure your Spring Security settings</li>
